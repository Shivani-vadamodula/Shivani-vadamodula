...
✅ Conditional Access Policies (CAP) & MFA Implementation  
✅ Cross-Tenant Management & Company Branding  
...
I am actively studying **ethical hacking methodologies, cloud penetration testing, and IAM attack vectors** to bridge the gap between **Azure security** and **offensive security techniques**.  

🎯 **Current Focus Areas:**  
📌 Privilege Escalation in Azure AD  
📌 Attacking & Defending Conditional Access Policies  
  

🚀 **Next Steps:**  
✅ Get Certified (SC-300, AZ-500, OSCP in the future)  
✅ Build & Share Ethical Hacking Labs for IAM  
